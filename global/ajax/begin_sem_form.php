...
if (
    ...
    try {
        ...
        $sem_begin_date = isset($_POST['sem_begin_date']) ? sanitizeInput($_POST['sem_begin_date'], 'string') : '';
        ...
        $params_procedures = [
            ...
            ['name' => 'sem_begin_date', 'type' => 's', 'value' => date(DB_DATE_FORMAT, strtotime($sem_begin_date))],
        ];
        
        $result = callProcedure("update_pr_sem_begin", $params_procedures);
        if ($result) {
