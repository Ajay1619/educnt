...
if (
    ...
    try {
        $day_type = isset($_POST['day_type']) ? sanitizeInput($_POST['day_type'], 'int') : '';
        $params_procedures = [
            ['name' => 'login_id', 'type' => 'i', 'value' => $logged_login_id],
            ['name' => 'day_type', 'type' => 'i', 'value' => $day_type],
        ];
        $result = callProcedure("fetch_pr_day_list", $params_procedures);
