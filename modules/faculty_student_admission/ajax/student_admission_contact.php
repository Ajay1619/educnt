...
if (
    ...
    if ($name == 'first_name' || $name == 'middle_name' || $name == 'last_name' || $name == 'initial') {
    ...
    if ($name == 'official_mail_id' || $name == 'personal_mail_id') {
    ...
    if ($name == "mobile_number" || $name == "alt_mobile_number" || $name == "whatsapp_mobile_number") {
