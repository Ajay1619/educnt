...
if (
    ...
    try {
        ...
        if ($existingAdmissionValue == 0) {
           
            echo json_encode(['code' => 404, 'status' => "success", 'message' => "no data fetch"]);
            exit;
        }
        
        $result = callProcedure("fetch_stu_admission_personal_data", $procedure_params);
