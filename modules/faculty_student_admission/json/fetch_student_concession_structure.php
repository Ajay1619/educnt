...
if (
    ...
    $student_id = 0;
    if (isset($existingAdmissionValue) && $existingAdmissionValue != 0) {
        $student_id = $existingAdmissionValue;
    } else {
    ...
    try {
        ...
        $result = callProcedure("fetch_pr_individual_student_concession_structure", $procedure_params);
