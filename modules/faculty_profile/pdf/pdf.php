...
class CustomPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        if ($this->page == 1) {
            ...
            $html = '<table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" width="6%"><img src="Frame 3922.png" alt=""><h1>Educnt</h1></td>
            ...
            $html = '<table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td align="left" width="6%"><img src="Frame 3922.png" alt=""></td>
    ...
    public function Footer()
    {
        ...
        $Footer = 'Footer.png';  // Replace with the actual SVG file path
