...
if (
    ...
    try {
        ...
        $result = callProcedure("fetch_pr_faculty_document_data", $procedure_params);
        if ($result) {
            if ($result['particulars'][0]['status_code'] == 200) {
                if ($result['data']) {
                    ...
                    echo json_encode(['code' => 302, 'status' => $result['particulars'][0]['status'], 'message' => $result['particulars'][0]['message']]);
                    exit;
                }
            } else {
