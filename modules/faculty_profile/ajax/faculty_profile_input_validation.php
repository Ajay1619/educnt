...
if (
    ...
    if ($name == 'first_name' || $name == 'middle_name' || $name == 'last_name' || $name == 'initial' || $name == 'parent_first_name' || $name == 'parent_middle_name' || $name == 'parent_last_name' || $name == 'parent_initial'   ) {
        $name = capitalizeFirstLetter($value);
        echo json_encode(['code' => 200, 'status' => 'success', 'message' => 'Capitalized the Input.', 'data' => $name]);
    }

    if ($name == 'address_street' || $name == 'address_locality' || $name == 'address_city' || $name == 'address_district' || $name == 'address_state' || $name == 'address_country' || $name == 'sslc_institution_name' || $name == 'hsc_institution_name' || $name == 'degree_institution_name[]' || $name == 'experience_designation[]' || $name == 'experience_industry_department[]' || $name == 'experience_industry_name[]' || $name == 'skills_input' || $name == 'software_skills_input' || $name == 'interest_input' || $name == 'languages_input') {
    ...
    if ($name == 'official_mail_id' || $name == 'personal_mail_id' ||$name == 'parent_email_id') {
    ...
    if ($name == "mobile_number" || $name == "alt_mobile_number" || $name == "whatsapp_mobile_number" ||$name == 'parent_mobile_number' ) {
